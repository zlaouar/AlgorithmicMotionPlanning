...
{
    //------------------------- Part (a) ----------------------------
    vector<int> nvec{200,200,200,200,500,500,500,500};
    vector<double> rvec{0.5,1,1.5,2,0.5,1,1.5,2};
    ...
    vector<graphNode> path, smooth_path; 
    int num_runs = 100;
    ...
    for(int i=0; i<nvec.size(); i++){
        ...
        for(int j=0; j<num_runs; j++){
            ...
            //cout << "done" <<endl;
            if(astar.valid_path){
                path = prm_planner.path_smooth(path, 50);
                astar.path_length = prm_planner.smooth_path_length;
            }
    ...
    ofstream path_file;
    path_file.open ("data/prm2aii_smooth_path.csv");
    ...
    ofstream valid_file;
    valid_file.open ("data/prm2aii_smooth_valid.csv");
    ...
    ofstream comp_file;
    comp_file.open ("data/prm2aii_smooth_comp.csv");
